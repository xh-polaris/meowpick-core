...
public class StartState extends AbstractCourseNote {
    public StartState(ICourseRepository repository) {
        super(repository);
    }
    ...
    public boolean start(String uid,
                         ...
                         CourseNoteEn en) {
        return repository.note(uid, course, cmd, CourseNoteEn.start);
    }
