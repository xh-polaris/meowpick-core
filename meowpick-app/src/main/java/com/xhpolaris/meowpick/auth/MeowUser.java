...
public class MeowUser extends User {
    ...
    public MeowUser(String username, String displayName, String userId, Collection<? extends GrantedAuthority> authorities) {
        super(username, "", authorities);
        this.setDisplayName(displayName);
        this.setUserId(userId);
    }

    public MeowUser(String username, String displayName, String userId, boolean accountUsable) {
